...
public class SearchProductAdapter extends RecyclerView.Adapter<SearchProductAdapter.ViewHolder> {
    ...
    List<SearchProduct> simpleProducts;
    LayoutInflater inflater = null;
    Context mContext;

    public SearchProductAdapter(Context mcontext, List<SearchProduct> simpleProducts) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.search_product_items, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        final SearchProduct item = simpleProducts.get(position);
...
//endregion
        ...
        holder.showMore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MyIntent.putExtra("SuperID", item.getSupermarketID());
                MyIntent.putExtra("SuperName", item.getSupermarketName());
...
//endregion
    ...
    public void addItems(List<SearchProduct> simpleProducts) {
...
//        urlConnection.setDoOutput(true);
    ...
    class SaveAsyncTask extends AsyncTask<SimpleProduct, Void, Void> {
        ...
        public SaveAsyncTask(SearchProduct item) {
            this.sitem=item;
        }
        Realm realm;
        @Override
        protected Void doInBackground(SimpleProduct... params) {
            try {
                ...
                databaseOrder.setSupermarketID(sitem.getSupermarketID());
                databaseOrder.setSupermarketName(sitem.getSupermarketName());
    ...
    class RemoveAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        private View layout;
        SearchProduct Pro;
        public RemoveAsyncTask(SearchProduct item) {
            this.Pro=item;
        }
        @Override
