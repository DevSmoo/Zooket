...
public class NearestSupermarketActivity extends BaseActivity {
    ...
    ViewPager pager;
    ViewPagerGPSAdapter pagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nearest_supermarket);
...
//        mRecyclerView.getLayoutParams().width = display.getWidth() * 80 / 100;
        ...
        final GestureDetector mGestureDetector = new GestureDetector(NearestSupermarketActivity.this, new GestureDetector.SimpleOnGestureListener() {
            @Override
                ...
                if (child != null && mGestureDetector.onTouchEvent(motionEvent)) {
                    ...
                    if (position != 0) {
                        ...
                        if (((TextView) child.findViewById(R.id.Email)).getText().toString().trim().isEmpty()) {
                            ...
                            //Go To Profile
                            Intent myIntent = new Intent(NearestSupermarketActivity.this, ProfileActivity.class);
        ...
        pagerAdapter = new ViewPagerGPSAdapter(getSupportFragmentManager());
