...
public class MaterialTabs extends HorizontalScrollView {
    ...
    public MaterialTabs(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabsContainer.setHorizontalGravity(Gravity.RIGHT);
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < tabCount; i++) {
            if (pager.getAdapter() instanceof CustomTabProvider) {
                ...
                tabView = LayoutInflater.from(getContext()).inflate(R.layout.materialtab, this, false);
            }
    ...
    private void updateTabStyles() {
        ...
        int px = Math.round(140 * (displayMetrics.xdpi / DisplayMetrics.DENSITY_DEFAULT));
        for (int i = 0; i < tabCount; i++) {
            ...
            // Mine
            ViewGroup.LayoutParams lp = tab_title.getLayoutParams();
